class MusixMatchModel {
  Message? message;

  MusixMatchModel({this.message});

  MusixMatchModel.fromJson(Map<String, dynamic> json) {
    message =
...
class Body {
  ...
  Body({this.trackList, this.track});
  ...
  Body.fromJson(Map<String, dynamic> json) {
    ...
    } else if (json['track'] != null) {
      track = Track.fromJson(json['track']);
    } else if (json['lyrics'] != null) {
...
class Track {
  ...
  Track.fromJson(Map<String, dynamic> json) {
    ...
    if (json['track_name_translation_list'] != null) {
      trackNameTranslationList = <dynamic>[];
